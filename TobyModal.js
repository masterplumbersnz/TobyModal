  ...
  var modalHTML = `
    <div id="myModal" class="toby-modal" style="display:none;">
      <div class="modal-content">
        ...
        <p>If you encounter any issues or would like to share your feedback, we welcome your input. Please use the 'Submit Feedback' button on the page below to submimt your comments and suggestions.</p>
      </div>
    </div>
  `;
